...
const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.store.postgres.connectionString":
    "Memory Search Postgres Connection String",
  "agents.defaults.memorySearch.store.postgres.host": "Memory Search Postgres Host",
  "agents.defaults.memorySearch.store.postgres.port": "Memory Search Postgres Port",
  "agents.defaults.memorySearch.store.postgres.user": "Memory Search Postgres User",
  "agents.defaults.memorySearch.store.postgres.password": "Memory Search Postgres Password",
  "agents.defaults.memorySearch.store.postgres.database": "Memory Search Postgres Database",
  ...
  "agents.defaults.memorySearch.recentWindowMessages": "Recent Window Messages",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.recentWindowMessages":
    "Number of most recent messages to include alongside RAG results for context building (default: 10).",
